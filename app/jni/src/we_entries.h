...
static const we_t WEBSITE_ENTRIES[] = {
	...
	},
	{
		...
		.name = "123hdd",
		.query = "123hdd",
		.url = "https://one-two-three-hdd.raiselysite.com/",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "24hd",
		.query = "24hd",
		.url = "https://24hd.raiselysite.com/",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	{
		.id = 0x5ff,
		.name = "OnePiece Liveaction 2",
		.query = "onepiece liveaction 2",
		.url = "https://one-piece-live-action-2-ep-1.raiselysite.com/",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "Serie day",
		.query = "serie day",
		.url = "https://series-day.raiselysite.com/",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "TVMon",
		.query = "tvmon",
		.url = "https://tvmonkorea.raiselysite.com/",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	{
		.id = 0x8bc,
		.name = "The undertaker 2",
		.query = "the undertaker 2",
		.url = "https://theundertaker2.raiselysite.com/",
		.email = "mailto:admin@raiselysite.com",
		.difficulty = 0x1000
	},
	{
		.id = 0x8bd,
